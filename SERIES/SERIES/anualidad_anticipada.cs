...
namespace SERIES
{
    public partial class anualidad_anticipada : Form
    {
        public anualidad_anticipada()
        {
            InitializeComponent();
        }
        ...
        private void btbcalcular_Click(object sender, EventArgs e)
        {
            ...
            if (txtanual.Text != String.Empty && txttasa.Text != String.Empty && txttiempo.Text != String.Empty)
            {
                ...
                txtVP.Text = (Math.Abs(Math.Round(anualidad * ((1 - Math.Pow((1 + tasa), (-tiempo))) / tasa)*(1 +tasa), 3))).ToString();
            ...
            else if (txttasa.Text != String.Empty && txttiempo.Text != String.Empty && txtVP.Text != String.Empty)
            {
                ...
                txtanual.Text = (Math.Abs(Math.Round(Vpresente/(((1 - Math.Pow((1 + tasa), (-tiempo))) / tasa) * (1 + tasa)), 3))).ToString();
            ...
            else if (txttasa.Text != String.Empty && txttiempo.Text != String.Empty && txtVF.Text != String.Empty)
            {
                ...
                txtVF.Text = (Math.Abs(Math.Round(anualidad * (((Math.Pow((1 + tasa), tiempo)) - 1) / tasa)*(1 + tasa), 3))).ToString();
            ...
            else if (txttasa.Text != String.Empty && txttiempo.Text != String.Empty && txtVP.Text != String.Empty)
            {
                ...
                txttiempo.Text = (Math.Abs(Math.Round(-Math.Log(1 - ((Vpresente * tasa) / (anualidad*(1+tasa)))) / Math.Log(1 + tasa), 3))).ToString();
